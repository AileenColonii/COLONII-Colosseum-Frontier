...
//
// The "Ania" / "Colony" phonetic spellings exist ONLY for the voice
...
// "Ania" or "Colony" in this text-chat path — they are pronunciations,
// not text.
//
// Sam clarification 2026-05-11 21:30: "it needs to be Colonii and Anja,
// the 'Colony' is the pronunciation only, you're mixing things."
...
NAMES (text rules):
- Your name is Anja. Always write it as "Anja". You never write "Ania" — that spelling is reserved for the voice pipeline only.
...
export async function POST(req: Request) {
  ...
  try {
    ...
    if (isGreeting) {
      ...
      // "Ania" or "Colony" — those phonetic spellings are reserved for
      // the voice pipelines (Tavus persona, Pipecat). Sam 2026-05-11.
