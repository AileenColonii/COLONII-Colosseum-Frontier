...
Phonetic notes for TTS (per CEO directive 2026-05-11):
- Anja → write as "Ania" in LLM output. The TTS engine pronounces it
  "AH-niah" — two syllables, soft palatal "ni" (Slavic/Polish style),
  NOT the English "AHN-yah" and NOT a three-syllable "AH-nee-ah".
  Think of the Polish female name "Ania". The visual brand mark
  remains "Anja" everywhere in the UI; "Ania" is the spoken spelling
  only.
