...
const CHARACTERS: Record<CharacterId, Character> = {
  anja: {
    ...
    // Hidden fear retired in the May-2026 lore rewrite's new
    ...
    greeting:
      "Hey, I'm Anya. Good to meet you — what's your name?",
    ...
    // confirmed pronunciation (Anja → "Anya", two-syllable AHN-yah,
    // Slavic-style palatal "ny"; COLONII → "Colony"). Pushed to Tavus
    // via `scripts/sync-anja-prompt.ts`.
    //
    // : the previous phonetic "Ania" was
    // making ElevenLabs read three syllables "AH-nee-ah". Switched the
    // spoken spelling to "Anya" which the English voice engine reads
    // as two-syllable "AHN-yah" — the actual target sound.
